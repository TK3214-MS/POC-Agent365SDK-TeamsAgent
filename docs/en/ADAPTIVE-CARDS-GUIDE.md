...
## 🎨 Implemented Adaptive Card Types
...
- 📝 Easy-to-read layout divided into sections
- ⏱️ Timestamp display
...
```
┌─────────────────────────────────────────┐
│ 📊 Sales Support Agent - Summary Report │
├─────────────────────────────────────────┤
│ ## 📧 Sales-related Emails (5)          │
│ - Subject 1                             │
│ - Subject 2                             │
│                                         │
│ ## 📅 Sales-related Events (3)          │
│ - Event 1                               │
│ - Event 2                               │
│                                         │
...
│ - Verify M365 permissions               │
│                                         │
│ ⚠️ An error occurred.                   │
│ Updated: 2026/02/05 18:30:00            │
└─────────────────────────────────────────┘
```
